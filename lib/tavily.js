...
const PPSF_AFTER_RE = new RegExp(
  // optional short qualifier ("of sold homes", "for homes sold in 77005, Houston, TX,"),
  // then an explicit value link right before the amount; no crossing `$ ; .`
  `(?:per|/)\\s*(?:sq\\.?\\s?ft|square\\s?foot|sqft)[^$;.]{0,60}?(?:\\b(?:of|was|is|at|averages?|around|about)\\b|:|-|–|—)\\s*\\$\\s?${NUM}`,
  "gi"
);
